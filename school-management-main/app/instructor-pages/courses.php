                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    if (isset($_POST['request'])) {
                                        ...
                                        if (!$conn) {
                                            ...
                                            $sql = "SELECT DISTINCT grade.student_id,course.course_name,course.course_id,grade.homework_grade ,grade.quiz_grade ,grade.midterm_grade ,grade.final_grade FROM `course` INNER JOIN grade ON grade.course_id=course.course_id WHERE course.course_id= '" . $_POST['course_id'] . "' AND course.registered_student != 'NULL'";
                                            $result = mysqli_query($conn, $sql);
